...
### input data
df=pd.read_csv("../../dat/vap/vap_inp.csv")
#df=df.fillna(0)
iso3=df["ISO3"]

### get average
data=df.mean(axis="columns")
fn_out="Value_of_Agricultural_Production_average.png"
...
ax.set_title("Value of Agricultural Production : average of 1961-2016 (1000 I$, by FAOstat)")
...
plt.savefig("../../fig/vap/"+fn_out, dpi=300, bbox_inches="tight")
plt.show()
