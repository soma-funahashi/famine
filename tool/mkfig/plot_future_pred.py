...
def calc(inp):
    ...
    for i in range(len(inp)):
        for yr in range(2021, 2051):
            if inp.iat[i, yr - 2021] < 0.01:
                out[0][yr - 2021] += 1
            elif inp.iat[i, yr - 2021] < 0.02:
                out[1][yr - 2021] += 1
            elif inp.iat[i, yr - 2021] < 0.05:
                out[2][yr - 2021] += 1
            else:
                out[3][yr - 2021] += 1
    return out
...
plot_fill_1(1, "#CBE6F3", "Prob. 0.01~0.02")
plot_fill_1(2, "#6EB7DB", "Prob. 0.02~0.05")
plot_fill_1(3, "#007AB7", "Prob. 0.05~1.00")

plot_fill_2(1, "#C6EDDB", "Prob. 0.01~0.02")
plot_fill_2(2, "#64C99B", "Prob. 0.02~0.05")
plot_fill_2(3, "#009250", "Prob. 0.05~1.00")

plot_fill_3(1, "#F9DFD5", "Prob. 0.01~0.02")
plot_fill_3(2, "#EDA184", "Prob. 0.02~0.05")
plot_fill_3(3, "#DA5019", "Prob. 0.05~1.00")
...
plt.savefig("../../fig/plt/future_precdiction.png", dpi=300, bbox_inches="tight")
