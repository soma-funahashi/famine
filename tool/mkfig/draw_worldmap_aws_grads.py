...
### input data
df=pd.read_csv("../../dat/aws/mod2_SupAgr__WFDELECD.csv")
#df=df.fillna(0)
iso3=df["ISO3"]
...
ax.set_title("Agricultural Water Supply : average of 1979-2014 (H08 output, kg/s)")
...
plt.savefig("../../fig/aws/"+fn_out, dpi=300, bbox_inches="tight")
plt.show()
plt.close()
