...
### input data
df=pd.read_csv("../../out/multipleRegression.csv")
df=df.fillna(0)
iso3=df["ISO3"]
...
year=s[1]
data=df[str(year)]
fn_out="multipleRegression_"+str(year)+".png"
...
ax.set_title("Famine Vulnerability in "+str(year))
...
#plt.show()
plt.savefig("../../fig/out/"+fn_out,bbox_inches="tight")