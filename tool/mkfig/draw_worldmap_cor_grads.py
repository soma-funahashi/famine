...
### input data
df=pd.read_csv("../../dat/cor/correlation_data.csv")
#df=df.fillna(0)
iso3=df["ISO3"]

### get average
data=df.mean(axis="columns")
fn_out="cor_aws_vap.png"
...
ax.set_title("Correlation Coefficient b/w AWS and VAP")

### setting colormap
cmap=plt.get_cmap("coolwarm")
norm = Normalize(vmin=-m, vmax=m)
#norm = colors.SymLogNorm(linthresh=1.1, linscale=1.1, vmin=-m, vmax=m)
...
plt.savefig("../../fig/cor/"+fn_out, dpi=300, bbox_inches="tight")
plt.show()
