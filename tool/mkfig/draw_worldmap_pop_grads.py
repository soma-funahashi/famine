...
### input data
df=pd.read_csv("../../dat/pop/population_inp.csv")
#df=df.fillna(0)
iso3=df["ISO3"]

### get average
data=df.mean(axis="columns")
fn_out="population_average.png"
...
ax.set_title("Population : average of 1961-2011 (%)")
...
plt.savefig("../../fig/pop/"+fn_out, dpi=300, bbox_inches="tight")
plt.show()
