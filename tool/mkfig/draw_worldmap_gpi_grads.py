...
### input data
df=pd.read_csv("../../dat/gpi/global_peace_index.csv")
#df=df.fillna(0)
iso3=df["ISO3"]

### get average
data=df.mean(axis="columns")
fn_out="GPI_average.png"
...
ax.set_title("Global Peace Index : average of 2007-2018")
...
plt.savefig("../../fig/gpi/"+fn_out, dpi=300, bbox_inches="tight")
plt.show()
